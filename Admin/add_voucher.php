...
<?php 
	if(isset($_POST['addv']))
	{
		...
		$exdate=$_POST['exdate'];
		$status=1;
		$sql=$link->insert("voucher_tb",Array("voucher_life"=>$nv,"voucher_code"=>$vc,"voucher_amount"=>$va,"voucher_expiry_date"=>$exdate,"status"=>$status));
		if($sql)
		{
...
<head>
    ...
    <title>360 Overseas Admin - Add Voucher</title>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input class="form-control" type="number" min="0" id="nv" name="nv">
			  ...
			  <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input class="form-control" type="text" id="vc" name="vc">
			  ...
			  <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input class="form-control" type="number" min="0" id="va" name="va">
			  ...
			  <div class="form-group row">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="exdate"/>
             ...
             <div>
                ...
                <center>
                <input type="submit" class="btn btn-info pull-right" value="Add" name="addv" style="align:center">
               </center>
              </div>
