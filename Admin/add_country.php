...
<?php 
  if(isset($_POST['addcon']))
  {
    ...
    $status=1;
    $conimg=$_FILES['conimage']['name'];
    $sql=$link->insert('country_tb',Array('country_name'=>$conname,'status'=>$status));
    if($sql)
    {
      $ext=pathinfo($conimg,PATHINFO_EXTENSION);
      $path="images/country/".$sql.".".$ext;
      $link->where('country_id_pk',$sql);
...
<head>
    ...
    <title>360 Overseas Admin - Add Country</title>
  ...
  <link rel="stylesheet" href="css/bootstrap-datepicker.min.css">
	...
	function check()
	{
		...
		if(conimage=="")
		{
			document.getElementById("sconimage").innerHTML="Please Select Image";
			s=false;
		}
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input class="form-control" type="text" id="conname" name="conname">
             ...
             <div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input class="form-control" type="file" id="conimage" name="conimage">
				<span id="sconimage" style="color:red;"></span>
                </div>
              </div>

                <center>
                <input type="submit" class="btn btn-info pull-right" value="Add" name="addcon" style="align:center">
               </center>
              </div>
