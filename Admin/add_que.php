...
<?php 
  if(isset($_POST['addq']))
  {
    ...
    $sql=$link->insert('faq_tb',Array('question'=>$que,'status'=>$status,'answer'=>$ans));
    if($sql)
    {
...
<head>
    ...
    <title>360 Overseas Admin - Add Frequently Asked Questions</title>
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Add Frequently Asked Questions</h3>
          ...
          <div class="row">
            <div class="col-12">
             ...
             <div>
                ...
                <center>
                <input type="submit" class="btn btn-info pull-right" value="Add" name="addq" style="align:center">
               </center>
              </div>
