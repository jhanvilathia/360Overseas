...
<head>
    ...
    function confirmdelete(id)
  {
    ...
    if(a)
    {
      window.location.replace("delete_country.php?id="+id);
    }
  }
  </script>
    <meta charset="utf-8">
    ...
    <title>360 Overseas Admin - View Country</title>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="table-responsive">
          ...
          <tbody>
            <?php 
            $sql = $link->rawQuery("select * from country_tb where status=?",Array("status"=>1));
            foreach ($sql as $s) 
            { ?>
             <tr>
              <td><?php echo $s['country_name']; ?></td>
              <td><img src="<?php echo $s['country_image']; ?>" height=50 width=50 alt="image"/></td>
            <td><a href="edit_country.php?id=<?php echo $s['country_id_pk']; ?>&img=<?php echo $s['country_image']; ?>"><img src="images/edit.png" height=20 width=20/></a></td>
            <td><a href="#" onClick=confirmdelete(<?php echo $s['country_id_pk']; ?>)><img src="images/delete.png" height=25 width=25/></a></td>
             </tr>
           <?php }
