...
<?php 
  if(isset($_POST['addcat']))
  {
    ...
    $status=1;
    $catimg=$_FILES['catimage']['name'];
    $sql=$link->insert('category_tb',Array('category_name'=>$catname,'status'=>$status));
    if($sql)
    {
      $ext=pathinfo($catimg,PATHINFO_EXTENSION);
      $path="images/category/".$sql.".".$ext;
      $link->where('category_id_pk',$sql);
...
<head>
    ...
    <title>360 Overseas Admin - Add Category</title>
  ...
  <link rel="stylesheet" href="css/bootstrap-datepicker.min.css">
	...
	function check()
	{
		...
		if(catimage=="")
		{
			document.getElementById("scatimage").innerHTML="Please Select Image";
			s=false;
		}
            ...
            <div class="col-12">
             ...
             <div>
              <div class="form-group row">
                ...
                <center>
                <input type="submit" class="btn btn-info pull-right" value="Add" name="addcat" style="align:center">
               </center>
              </div>
