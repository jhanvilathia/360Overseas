...
<head>
    ...
    function confirmdelete(id)
  {
    ...
    if(a)
    {
      window.location.replace("delete_voucher.php?id="+id);
    }
  }
  </script>
    <meta charset="utf-8">
    ...
    <title>360 Overseas Admin - Vouchers</title>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="table-responsive">
          ...
          <tbody>
            <?php 
            $sql = $link->rawQuery("select * from voucher_tb where status=? ",Array("status"=>1));
            foreach ($sql as $s) 
            { ?>
             <tr>
              <td><?php echo $s['voucher_life']; ?></td>
              <td><?php echo $s['voucher_used']; ?></td>
              <td><?php echo $s['voucher_code']; ?></td>
              <td><?php echo $s['voucher_amount']; ?></td>
              <td><?php echo $s['voucher_expiry_date']; ?></td>
			  
            <td><a href="edit_voucher.php?id=<?php echo $s['voucher_id_pk']; ?>"><img src="images/edit.png" height=20 width=20/></a></td>
            <td><a href="#" onClick=confirmdelete(<?php echo $s['voucher_id_pk']; ?>)><img src="images/delete.png" height=25 width=25/></a></td>
             </tr>
           <?php }
