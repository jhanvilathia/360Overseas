...
<?php 
  if(isset($_POST['addbanner']))
  {
    ...
    $sql=$link->insert('banner_tb',Array('sort_order'=>$sortOrder,'status'=>$status));
   
    if($sql)
    {
      $ext=pathinfo($banimage,PATHINFO_EXTENSION);
      $path="images/banner/".$sql.".".$ext;
      $link->where('banner_id_pk',$sql);
...
<head>
    ...
    <title>360 Overseas Admin - Add Banner</title>
  ...
  <link rel="stylesheet" href="css/bootstrap-datepicker.min.css">
	...
	function check()
	{
		...
		if(banimage=="")
		{
			document.getElementById("sbanimage").innerHTML="Please Select Image";
			s=false;
		}
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input class="form-control" type="number" min="0" id="sortorder" name="sortorder">
             ...
             <div>
                ...
                <center>
                <input type="submit" class="btn btn-info pull-right" value="Add" name="addbanner" style="align:center">
               </center>
              </div>
