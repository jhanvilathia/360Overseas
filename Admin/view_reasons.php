...
<head>
    ...
    function confirmdelete(id)
  {
    ...
    if(a)
    {
      window.location.replace("delete_reason.php?id="+id);
    }
  }
  </script>
    <meta charset="utf-8">
    ...
    <title>360 Overseas Admin - View Reasons</title>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="table-responsive">
          ...
          <tbody>
            <?php 
            $sql = $link->rawQuery("select * from cancel_tb where status=? ",Array("status"=>1));
            foreach ($sql as $s) 
            { ?>
             <tr>
			  ...
			  <td>
			  <center>
			  <div style="color:white;border-radius:10px;width:150px;text-align:center;
			  <?php
				if($s['type']=="trip") 
				{
					 echo "background-color:red;"; 
				}
				else if($s['type']=="accepted")
				{					
					echo "background-color:blue;";
				}				
				else if($s['type']=="posted")
				{					
					echo "background-color:green;";
				}?>
					">
			  <span><?php echo $s['type'];?></span>
			  
			  </div>
			  </center>
			  </td>
            <td><a href="edit_reason.php?id=<?php echo $s['reason_id_pk']; ?>"><img src="images/edit.png" height=20 width=20/></a></td>
            <td><a href="#" onClick=confirmdelete(<?php echo $s['reason_id_pk']; ?>)><img src="images/delete.png" height=25 width=25/></a></td>
             </tr>
           <?php }
