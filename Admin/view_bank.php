...
<head>
    ...
    function confirmdelete(id)
  {
    ...
    if(a)
    {
      window.location.replace("delete_bank.php?id="+id);
    }
  }
  </script>
    <meta charset="utf-8">
    ...
    <title>360 Overseas Admin - View bank</title>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="table-responsive">
          ...
          <tbody>
            <?php 
            $sql = $link->rawQuery("select * from bank_tb where status=?",Array("status"=>1));
            foreach ($sql as $s) 
            { ?>
             <tr>
              <td><?php echo $s['bank_name']; ?></td>
            <td><a href="edit_bank.php?id=<?php echo $s['bank_id_pk']; ?>"><img src="images/edit.png" height=20 width=20/></a></td>
            <td><a href="#" onClick=confirmdelete(<?php echo $s['bank_id_pk']; ?>)><img src="images/delete.png" height=25 width=25/></a></td>
             </tr>
           <?php }
