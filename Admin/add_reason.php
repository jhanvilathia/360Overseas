...
<?php 
  if(isset($_POST['addr']))
  {
	  $type=$_POST['type'];
	  $reason=$_POST['reason'];
	  $sql=$link->insert('cancel_tb',Array('type'=>$type,'reason'=>$reason));
	  if($sql)
	  {
...
<head>
    ...
    <title>360 Overseas Admin - Add Reasons</title>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group row">
                <label for="example-text-input" class="col-sm-2 col-form-label">Reason Type</label>
                <div class="col-sm-10">
                <select name="type" class="form-control" id="type">
				<option value="-1">Select Type Of Member</option>
				<option value="trip">For Trip</option>
				<option value="posted">For Posted Requests</option>
				<option value="accepted">For Accepted Requests</option>
				</select>
             ...
             <div>
              <div class="form-group row">
                ...
                <center>
                <input type="submit" class="btn btn-info pull-right" value="Add" name="addr" style="align:center">
               </center>
              </div>
