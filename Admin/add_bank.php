...
<?php 
  if(isset($_POST['addbank']))
  {
    ...
    $sql=$link->insert('bank_tb',Array('bank_name'=>$bankname,'status'=>$status));
    if($sql)
    {
...
<head>
    ...
    <title>360 Overseas Admin - Add Bank</title>
          ...
          <div class="row">
            <div class="col-12">
             ...
             <div>
                ...
                <center>
                <input type="submit" class="btn btn-info pull-right" value="Add" name="addbank" style="align:center">
               </center>
              </div>
