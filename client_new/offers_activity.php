...
<head>
    ...
    <title>360 Overseas || Offered Requests</title>
    ...
    <div class="cart-top-heading">
        <div class="container">
            <div class="summery-top">
                <div class="row">
                    <div class="9col-md-6 col-sm-6 col-xs-12">
                        <div class="cart-sumttl">
                            <h3>Requests you have offered to help.</h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
						...
						// $r=$link->rawQuery("select request_id_fk from offer_accepted_tb where traveller_id_fk=?",Array($_SESSION['member_id']));
						// foreach($r as $r1)
						// {
						$sql=$link->rawQuery("select * from request_tb,offered_requests_tb where request_id_pk=request_id_fk and traveller_id_fk=? and status!='open'",Array($_SESSION['member_id']));
						$count=$link->count;
						?>
                            <p>You have <?php echo $count; ?> Offerered Requests.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12">
                    <div class="progress-summery text-center">
                        <ul class="progress-steps">
							...
							<li class="steps-item  litext is-active" style="width:30%;"><a href="offers_activity.php">Your Offers</a>
                            </li>
                        </ul>
                    </div>
                </div>
