...
<head>
    ...
    <title>360 Overseas || Country</title>
                    ...
                    <div class="product-banner-right">
                        <div class="img-banner">
                            <div class="pbanner-image hvreff-defm10 posr">
                                <img src="<?php echo $siteroot . $con['country_image'];?>" alt="" style="height:247px;width:370px">
                            </div>
							<div class="collection-btn btn-area-comm1">
								<a class="btn-def btn-def-white1" href="shop.php?id=<?php echo $con['country_id_pk'];?>"><?php echo $con['country_name'];?></a>
								<p style="text-align:center"><b>Total Requests: <?php 
									
									$q=$link->rawQueryOne("select count(*) as cnt from request_tb where country_id_fk=?",Array($con['country_id_pk']));
									echo $q['cnt'];
								?><br>Total Trips: <?php $q1=$link->rawQueryOne("select count(*) as cnt from trip_tb where country_id=?",Array($con['country_id_pk']));
									echo $q1['cnt'];?></b></p>
							</div>
                        </div>
